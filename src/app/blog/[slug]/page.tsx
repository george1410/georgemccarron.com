  ...
  return (
    <main>
      <article className='flex flex-col'>
        ...
        <Link
          href='/blog'
          className='self-center border-2 border-slate-200 py-2 px-4 rounded-lg font-medium text-slate-400 hover:bg-slate-100 w-full md:w-auto text-center mt-4 md:mt-0'
        >
          Back to All Posts
        </Link>
      </article>
